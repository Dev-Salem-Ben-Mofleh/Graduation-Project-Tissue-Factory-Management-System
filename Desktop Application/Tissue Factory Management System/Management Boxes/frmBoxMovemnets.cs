...
{
    public partial class frmBoxMovemnets : Form
    {
        public frmBoxMovemnets()
        {
            InitializeComponent();
        }
        ...
        private static DataTable _dtAllStoockMovemnts = clsBoxMovement.GetAllBoxMovements();

        private DataTable _dtPeople = _dtAllStoockMovemnts.DefaultView.ToTable(false, "BoxMovementID", "BoxMovementDate",
            "Amount", "MovementType", "BoxName", "Name"
            );

        private void _RefresPrudctionlList()
        {
            _dtAllStoockMovemnts = clsBoxMovement.GetAllBoxMovements();
            _dtPeople = _dtAllStoockMovemnts.DefaultView.ToTable(false, "BoxMovementID", "BoxMovementDate",
            "Amount", "MovementType", "BoxName", "Name"
            );
        ...
        {
            string FilterColumn = "BoxMovementDate";
        ...
        {
            string FilterColumn = "MovementType";
            ...
            if (FilterValue == "الكل")
                ...
                "[{0}] LIKE '{1}%' AND [BoxMovementDate] >= #{2}# AND [BoxMovementDate] <= #{3}#",
                FilterColumn,
                cbTypeMove.Text.Trim(),
                dtFrom.Value.ToString("MM/dd/yyyy"),
                dtTo.Value.ToString("MM/dd/yyyy")
            );
        ...
        private void frmBoxMovemnets_Load(object sender, EventArgs e)
        {
            ...
            lblRecordsCountStocks.Text = dgvStocks.Rows.Count.ToString();
                ...
                dgvStocks.Columns[0].HeaderText = "رقم حركة الصندوق";
                dgvStocks.Columns[0].Width = 150;

                dgvStocks.Columns[1].HeaderText = "تاريخ الحركة";
                ...
                dgvStocks.Columns[3].HeaderText = "نوع العملية";
                dgvStocks.Columns[3].Width = 100;

                dgvStocks.Columns[4].HeaderText =  "أسم الصندوق";
                dgvStocks.Columns[4].Width = 200;

                dgvStocks.Columns[5].HeaderText = "اسم المستخدم";
        ...
        private void txSearchBy_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                case "رقم حركة الصندوق":
                    FilterColumn = "BoxMovementID";
                    break;
        ...
        private void txSearchBy_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (cbFilter.Text == "رقم حركة الصندوق")
