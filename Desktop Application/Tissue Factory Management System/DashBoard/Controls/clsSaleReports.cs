...
{
    public partial class clsSaleReports : UserControl
    {
        public clsSaleReports()
        {
            InitializeComponent();
        }
        ...
        private void _LoadChartCircle(DateTime dateFrom, DateTime dateTo)
        {
            ...
            DataTable Paid = clsSale.GetSalePaid(dateFrom, dateTo);
            DataTable NoPaid = clsSale.GetSaleNoPaid(dateFrom, dateTo);
            DataTable Total = clsSale.GetSaleTotal(dateFrom, dateTo);
        ...
        private void _LoadChartLine(DateTime dateFrom, DateTime dateTo)
        {
            ...
            DataTable AllInfo = clsSale.GetSaleReportForDashboard(dateFrom, dateTo);

            chart2.Series.Clear();

            chart2.Series.Add("الفواتير المباعة");
            ...
            {
                days.Add(Convert.ToDateTime(Row["SaleDate"]).ToString("dd-MM"));
            ...
            {
                chart2.Series["الفواتير المباعة"].Points.AddXY(days[i], totalInvoices[i]);
            ...
            chart2.Series["الفواتير المباعة"].Color = Color.Green;
