...
class RawMaterailReportScreen extends StatefulWidget {
  @override
  _RawMaterailReportScreenState createState() =>
      _RawMaterailReportScreenState();
}

class _RawMaterailReportScreenState extends State<RawMaterailReportScreen> {
  ...
  Future<void> _fetchReport(String date) async {
    ...
    try {
      final response = await http.get(
        Uri.parse('https://tissue.runasp.net/api/Tissue/GetRawReport/$date'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('📦 تقارير المواد الخام'),
        centerTitle: true,
