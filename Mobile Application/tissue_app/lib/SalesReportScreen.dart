  ...
  Future<void> _fetchReport(String date) async {
    ...
    try {
      final response = await http.get(
        Uri.parse('https://tissue.runasp.net/api/Tissue/GetSaleReport/$date'),
                ...
                : _reportData == null || _reportData!.isEmpty
                    ...
                    : Column(
                        children: [
                          ...
                          _buildInfoCard(
                            '✅ المبلغ المدفوع',
                            '${_reportData![0]['paidBill']} ريال',
                            Icons.check_circle,
                            Colors.green,
                          ),
                          _buildInfoCard(
                            '💸 المبلغ المتبقي',
                            '${_reportData![0]['notPaidBill']} ريال',
                            Icons.pending,
                            Colors.red,
                          ),
                        ],
