...
class ElectricityReportScreen extends StatefulWidget {
  @override
  _ElectricityReportScreenState createState() =>
      _ElectricityReportScreenState();
}

class _ElectricityReportScreenState extends State<ElectricityReportScreen> {
  ...
  Future<void> _fetchReport(String date) async {
    ...
    try {
      final response = await http.get(
        Uri.parse('https://tissue.runasp.net/api/Tissue/GetEleReport/$date'),
                ...
                : _reportData == null || _reportData!.isEmpty
                    ...
                    : Column(
                        children: [
                          _buildInfoCard(
                            '📅 التاريخ',
                            _reportData![0]['date'].toString().split('T')[0],
                            Icons.calendar_today,
                            Colors.blue,
                          ),
                          _buildInfoCard(
                            '🛢️ نوع النفط',
                            _reportData![0]['typeOf'],
